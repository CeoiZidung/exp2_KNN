...
if __name__=='__main__':
    ...
    parser.add_argument('--ten', default=500, type=int, help='test num')
    ...
    t1=time.time()
    #对降维后数据进行建树
    kd_tree=KDtree(train_data_pca[:args.trn],train_labels[:int(args.trn)],dis_mes=args.disMes,fea_sec=args.feaSec) #创建KD树
    t2=time.time()
